...
class __TwigTemplate_3ebfe10c98c21f14a31cd2e8d3f3d8cc extends Template
{
    private $source;
    private $macros = [];
...
{% if link -%}
  {{ link }}
{%- endif %}
", "modules/contrib/token/templates/token-tree-link.html.twig", "/var/www/html/drupal/modules/contrib/token/templates/token-tree-link.html.twig");
    }
